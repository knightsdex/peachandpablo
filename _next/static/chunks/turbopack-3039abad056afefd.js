(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  "object" == typeof document ? document.currentScript : void 0,
  {
    otherChunks: [
      ...
      "static/chunks/9ead6849b0b3928b.js",
      "static/chunks/c0ab35e89dea4ae5.js",
  ...
  (() => {
    ...
    async function P(e, t, r) {
      let n;
      if ("string" == typeof r) return A(e, t, E(r));
      let o = r.included || [],
      ...
      if (s.length > 0) {
        ...
        for (let o of ((n = A(e, t, E(r.path))), i)) _.has(o) || _.set(o, n);
      }
    ...
    function E(e) {
      return `${t}${e
        ...
        .join("/")}?dpl=dpl_4wyoyxtRHjpLCrMNjEbuMXTgV91R`;
    }
    (R.L = function (e) {
...
importScripts(...self.TURBOPACK_NEXT_CHUNK_URLS.map(c => self.TURBOPACK_WORKER_LOCATION + c).reverse());`,
    ...
    e = {
      async registerChunk(e, t) {
        if ((W(E(e)).resolve(), null != t)) {
          for (let e of t.otherChunks) W(E("string" == typeof e ? e : e.path));
          if (
...
(function () {
  ...
  s.setAttribute("data-deployment-id", "dpl_4wyoyxtRHjpLCrMNjEbuMXTgV91R");
