  ...
  (e, t, r) => {
    ...
    function m(t) {
      ...
      let n,
        o,
        u,
        [s, m] = (0, a.useOptimistic)(d.IDLE_LINK_STATUS),
        P = (0, a.useRef)(null),
        {
          href: v,
          as: E,
      ...
      let D = w ? o && "object" == typeof o && o.ref : A,
        K = a.default.useCallback(
          (e) => (
            null !== I &&
              (P.current = (0, d.mountLinkInstance)(e, F, I, k, M, m)),
            () => {
              P.current &&
        ...
        z = {
          ...
          onMouseEnter(e) {
            w || "function" != typeof N || N(e),
              ...
              I && M && (0, d.onNavigationIntent)(e.currentTarget, !0 === U);
          },
      ...
      return (
        (0, f.isAbsoluteUrl)(B)
          ? (z.href = B)
          : (w && !S && ("a" !== o.type || "href" in o.props)) ||
            (z.href = (0, p.addBasePath)(B)),
        (u = w
          ? a.default.cloneElement(o, z)
          : (0, i.jsx)("a", { ...$, ...z, children: n })),
